...
```
cd existing_repo
git remote add origin https://gitlab.com/DEERAJ_47/motion-detection.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/DEERAJ_47/motion-detection/-/settings/integrations)
